    ...
    return (
        <div className="flex items-center justify-between py-3">
            <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                    <p className="font-semibold text-[#1a1a1a] text-base md:text-lg">{name}</p>
            ...
            <div className="p-4 md:p-6">
                ...
                <div className="flex flex-col items-start mt-6 md:mt-8 gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                        <Link href="./orders/trackorder" className="bg-[#0A3917] text-white text-sm py-2 px-5 rounded-3xl hover:bg-green-900 transition inline-block text-center">
                            Track Order
                        </Link>
