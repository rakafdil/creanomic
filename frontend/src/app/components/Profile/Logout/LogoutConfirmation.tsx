...
export default function LogoutConfirmation() {
    ...
    return (
        <div className="max-w-sm mt-8 md:mt-16 bg-white rounded-lg px-4 md:px-0">
            <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-2">Logout</h2>
            <p className="text-sm md:text-base text-gray-600 mb-5">Are you sure you want to log out?</p>
