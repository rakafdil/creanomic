            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-white">
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-12">
                        ...
                        <h3 className="text-4xl font-bold text-gray-900 mb-3">Login to your account</h3>
                    ...
                    <div className="text-center mt-10">
                        ...
                        <a href="/auth?mode=signup" className="text-[#0A3917] font-bold hover:underline">Sign up</a>
                    </div>
                </div>
            </div>
        </section>
