            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center px-12 py-12 bg-white">
                <div className="w-full max-w-md">
                    ...
                    <div className="flex items-center justify-center mt-5">
                        <label className="flex items-start cursor-pointer">
                            ...
                            <span className="ml-2 text-gray-700 text-sm">
                                I agree to the <a href="#" className="text-[#0A3917] hover:underline font-medium">Terms & Conditions</a>
                            </span>
                        </label>
                    </div>
                    ...
                    <div className="text-center mt-8">
                        ...
                        <a href="/auth?mode=login" className="text-[#0A3917] font-bold hover:underline">Sign in</a>
                    </div>
                </div>
            </div>
        </section>
