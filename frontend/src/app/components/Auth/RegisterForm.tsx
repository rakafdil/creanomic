            ...
            <div className="w-full md:w-1/2 flex items-center justify-center relative z-10 px-8 py-16 mb-8 mt-30">
                <div className="origin-center w-full max-w-lg bg-white p-12 rounded-3xl shadow-2xl text-black">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-5xl font-bold mt-2 leading-tight">Create<br />Account</h2>
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full border-2 border-gray-200 rounded-full px-6 py-3 pr-12 focus:outline-none focus:border-[#74AB35] transition-colors placeholder:text-gray-400"
                            />
                            <button
                                type="button"
                    ...
                    <div className="text-center text-black text-base my-6 font-medium">or sign up with</div>
                    ...
                    <div className="text-center mt-8 text-base font-semibold">
                        ...
                        <a href="/auth?mode=login" className="text-[#77AB34] font-semibold hover:underline ml-1">Login</a>
                    </div>
                </div>
            </div>
        </section>
