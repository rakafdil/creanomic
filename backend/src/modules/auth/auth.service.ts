...
import type { UserData, Credentials, UserProfile } from '../../types/auth.ts'
...
export class AuthService {
    ...
    async signup(userData: UserData, redirectTo: string = 'http://localhost:3000/auth/callback') {
    ...
    async getUserProfile(userId: string) {
        try {
            ...
            throw new AppError("Failed to get user profile: " + (error as Error).message, 500);
        }
    }
